...
using NetworkApi.Communication.Scs.Client.Tcp;
using NetworkApi.Communication.Scs.Communication.EndPoints;
using NetworkApi.Communication.Scs.Server;
using NetworkApi.Communication.Scs.Server.Tcp;
using System;

namespace NetworkApi.Communication.Scs.Communication.EndPoints.Tcp
{
    /// <summary>
