...
namespace Data.DAO
{
    public class PlayerDAO : DAOManager
    {
        ...
        public PlayerDAO(string conStr) : base(conStr)
        {
            ...
            stopwatch.Stop();
            Logger.WriteLine(LogState.Info,"DAO: PlayerDAO Initialized with {0} Players in {1}s"
            , LoadTotalPlayers()
        ...
        public int SaveNewPlayer(Player player)
        {
            ...
            {
                Logger.WriteLine(LogState.Exception, "DAO: PLAYER SAVE ERROR! "+ ex.Message);
                return 0;
            }
            ...
            {
                Logger.WriteLine(LogState.Exception, "DAO: PLAYER DATA SAVE ERROR!" + ex.Message);
                return 0;
            }
        ...
        public void RemovePlayer(int playerId)
        {
            ...
            try
            {
                Logger.WriteLine(LogState.Info,"Player Reqlinquished On PID : {0}", playerId);
                SqlCommand.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
                Logger.WriteLine(LogState.Exception, "DAO: PLAYER REMOVE ERROR!" + ex.Message);
            }
        }
        ...
        public void UpdatePlayer(Player player)
        {
            ...
            {
                Logger.WriteLine(LogState.Exception,"DAO: PLAYER UPDATE ERROR!"+ ex.Message );
                return;
            }
            ...
            {
                Logger.WriteLine(LogState.Exception, "DAO: PLAYER DATA UPDATE ERROR!" + ex.Message);
                return;
            }
        }
        ...
        public int LoadTotalPlayers()
        {
            ...
            {
                Logger.WriteLine(LogState.Exception, "DAO: LOAD TOTAL PLAYERS ERROR!" + ex.Message);
            }
            return count;
        }
