...
namespace Utils
{
    public class DelayedAction
    {
        ...
        {
            Action = action;
            InvokeUtc = RandomUtilities.GetCurrentMilliseconds() + delay;
        ...
        {
            if (RandomUtilities.GetCurrentMilliseconds() < InvokeUtc)
                return;
            try
            {
                Action.Invoke();
            ...
            {
                Logger.Logger.WriteLine(Logger.LogState.Exception, "DelayedAction Ex: " + ex.Message);
            }
            finally
            {
                Abort();
